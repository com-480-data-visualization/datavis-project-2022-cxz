function plot_reel(sectors, countries, years, reset, width, height) {
    ...
    function horizons() {
        ...
        g.select("circle").transition()
            .duration(duration)
            .attr("transform", function (d) { return "translate(" + (w - 80) + "," + (-h / 4) + ")"; })
            .remove();

        g.select("text").transition()
            .duration(duration)
            .attr("transform", function (d) { return "translate(" + (w - 80) + "," + (h / 4 - 22) + ")"; })
            .attr("dy", "0em");
    ...
    function overlappingArea() {
        ...
        t.select("text")
            .attr("dy", ".31em")
            .attr("transform", function (d) { d = d.values[d.values.length - 1]; return "translate(" + (w - 80) + "," + y(d.price) + ")"; });
    ...
    function stackedBar() {
        ...
        t.select("text")
            ...
            .attr("transform", function (d) { d = d.values[d.values.length - 1]; return "translate(" + (w - 80) + "," + y(d.price / 2 + d.price0) + ")"; });
